...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Data-Constraint> or 
L<MetaCPAN|http://www.metacpan.org/module/Data::Constraint>:

=over 4

=item *	L<http://search.cpan.org/dist/Data-Constraint>

=item *	L<http://www.metacpan.org/module/Data::Constraint>
